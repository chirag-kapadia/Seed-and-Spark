	...
	<body>
		...
		<div class="main-page-wrapper">
			...
			<!-- Select Expert Area Detail Query start -->
				<?php 
					$select_ExpertArea="select * from tblExpertArea where ExpertAreaID=".$_REQUEST['ExpertAreaID'];
					...
					<div class="banner-opacity">
						<div class="container">
							<div class="banner-content">
								<h1><?php if(isset($_REQUEST['ExpertAreaID'])) echo $Fetch_ExpertArea['AreaName']; ?></h1>
								<p>Explore A New World Of Things Here<br>Invest It</p>
								<ul>
									<li><a href="index.html">Home</a></li>
									<li><span>-</span></li>
									<li><a href="#"><?php if(isset($_REQUEST['ExpertAreaID'])) echo $Fetch_ExpertArea['AreaName']; ?> Projects</a></li>
								</ul>
						...
						<div class="row">
							<div class="col-md-8 col-xs-12 margin-top">
								<!-- Select Project ExpertArea wise query start -->
									<?php 
										$Select_Project="select * from tblProject where ExpertAreaID='".$_REQUEST['ExpertAreaID']."' and IsApprovedByExpert=1 and IsApprovedByAdmin=1 and IsActive=1 and IsComplete=0";
								...
								<div class="Causes-Item Causes-Sidebar-Item clear-fix">
									...
									<div class="Causes-Text">
										<h3><?php if(isset($_REQUEST['ExpertAreaID'])) echo $Fetch_Project['ProjectTitle']; ?></h3>
										<ul>
											<li>Invested</li>
											<li>
										...
										<p><?php if(isset($_REQUEST['ExpertAreaID'])) echo $Fetch_Project['SmallDescription']; ?></p>
