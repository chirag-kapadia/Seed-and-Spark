							...
							<div class="single-product-details">
								<div class="row">
									...
									<div class="col-lg-5 col-xs-12">
										<div class="product-order-details">
											...
											<a href="InvesterList.php?ProjectID=<?php echo $_REQUEST['ProjectID'];?>" style="color: #ff6a00">
											<li><span style="color: #ff6a00;"><b><?php echo $Fetch_Fund['Count'];?></b></span> Donations</li></a><br>
														<li>
															<?php 
																if(isset($_SESSION['IsInvestor']))
																{
																	...
																	{
															?>
																		<button style="width: 250px;height: 50px;color: white;background-color: #ff6a00;" class="hvr-float-shadow"><a href="PaymentDemo.php?ProjectID=<?php echo $_REQUEST['ProjectID'];?>">Invest this project</a></button>
															<?php
																	}
																}
															?><!-- <a href="#" class="hvr-float-shadow">Add To Cart</a> --></li>
													</ul> 
													</center>
												</div>			
											</div>
									...
									<div class="Text">
										<div class="clearfix">
											...
											<ul class="float-right">							
												...
												<input name="star" type="radio" class="star" disabled="disabled" <?php if(isset($Fetch_Review['Rating'])) { if($Fetch_Review['Rating']==1) { ?> checked="checked"<?php  }}?>  align="middle"/>
												<input name="star" type="radio" class="star" disabled="disabled" <?php if(isset($Fetch_Review['Rating'])) { if($Fetch_Review['Rating']==2) { ?> checked="checked"<?php  }}?> align="middle"/>
												<input name="star" type="radio" class="star" disabled="disabled" <?php if(isset($Fetch_Review['Rating'])) { if($Fetch_Review['Rating']==3) { ?> checked="checked"<?php  }}?> align="middle"/>
												<input name="star" type="radio" class="star" disabled="disabled" <?php if(isset($Fetch_Review['Rating'])) { if($Fetch_Review['Rating']==4) { ?> checked="checked"<?php  }}?> align="middle" />
												<input name="star" type="radio" class="star" disabled="disabled" <?php if(isset($Fetch_Review['Rating'])) { if($Fetch_Review['Rating']==5) { ?> checked="checked"<?php  }}?> align="middle" />
											</ul>
											<ul class="float-right">							

												<div class="col-sm-6 col-xs-12">
												<label style="font-size: 12px; color:white;">Realistic<br> Percentage</label>
												<input type="range" min="1" max="100" value="0" class="slider" id="myRange" name="txtRealistic" required="">
  												...
  												<?php echo $a1=$Fetch_Review['SuccessfulPercentage'];?>
											...
											<div class="col-sm-6 col-xs-12">
												<label style="font-size: 12px; color:white;">Successfull<br> Percentage</label>
												<input type="range" min="1" max="100" value="0" class="slider" id="myRange1" name="txtSuccessful" required="">
  												...
  												<!-- Range slider javascript start -->
  												<?php echo $a2=$Fetch_Review['RealisticPercetage'];?>
  												<script type="text/javascript">
								...
								<div class="review-tab">
									<ul class="nav nav-tabs">
										...
										<li><a data-toggle="tab" href="#menu1">Project Progress</a></li>
											 ...
											 if($pern>=100)
												{
													...
													{
											?>
										 				<button style="color:white;background-color: #ff6a00;height: 50px;width: 250px;" class="hvr-float-shadow"><a href="ProjectProgress.php?ProjectID=<?php echo $_REQUEST['ProjectID'];?>">Project Progress First Sloat</a></button>
										 <?php
										 			}
										 			if($Fetch_ppinfo['IsAcceptFirstSloat']==1 )
										 			{
										 		?>
										 				<button style="color:white;background-color: #ff6a00;height: 50px;width: 250px;" class="hvr-float-shadow"><a href="ProjectProgress.php?ProjectID=<?php echo $_REQUEST['ProjectID'];?>">Project Progress Second Sloat</a></button>
										 	...
										 	<?php	
										 			...
										 			{
										 	?>
										 				<button style="color:white;background-color: #ff6a00;height: 50px;width: 250px;" class="hvr-float-shadow"><a href="ProjectProgress.php?ProjectID=<?php echo $_REQUEST['ProjectID'];?>">Project Progress Third Sloat</a></button>
										 	<?php
										 			}
										 			if($Fetch_ppinfo['IsAcceptThirdSloat']==1)
										 			{	
										 	?>
										 				<button style="color:white;background-color: #ff6a00;height: 50px;width: 250px;" class="hvr-float-shadow"><a href="ProjectProgress.php?ProjectID=<?php echo $_REQUEST['ProjectID'];?>">Project Progress Fourth Sloat</a></button>
										 		<?php
										 			}
												...
												/**/
													if(isset($_REQUEST['btnSendAmount']))
													{
										                ...
										                {	
										                	...
										                	if($Fetch_Project['ReturnProjectProgressStatus']==25)
										                	{
										                		$update_Expert_return="update tblExpertReturn set IsSecoundReturn=1, SecondSlotSendOn=now() where ExpertReturnID='".$ExpertReturnID."'";
										                		//echo $update_investor_return;
										                		mysqli_query($con,$update_Expert_return)or die(mysqli_error($con));
										                	}
										                	if($Fetch_Project['ReturnProjectProgressStatus']==50)
							...
							<div class="Shop-Side-Bar">
								...
								<ul class="Popular-Product">
									...
									<li>
										...
										<h6><a href="View_Project.php?ProjectID=<?php echo $Fetch_Project['ProjectID'];?>"><?php echo $Fetch_Project['ProjectTitle']?></a></h6>
										<span>
															<?php 
