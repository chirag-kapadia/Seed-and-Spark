					...
					<div class="banner-opacity">
						<div class="container">
							<div class="banner-content">
								...
								<p>Provide Your Valuable Reviews To Various  <br>Projects</p>
								<ul>
							...
							<div class="col-md-8 col-xs-12 margin-top">
								<!-- Select Project ExpertArea wise query start -->
									<?php 
										...
										{
										$Select_Project="select * from tblProject where ExpertAreaID='".$Fetch_ExpertArea['ExpertAreaID']."' and IsApprovedByExpert=0 and IsApprovedByAdmin=0 and IsActive=1";
								...
								<div class="Causes-Item Causes-Sidebar-Item clear-fix">
									...
									<div class="Causes-Text">
										...
										<a href="ViewPendingProject.php?ProjectID=<?php echo $Fetch_Project['ProjectID']; ?>">View More</a>
									</div> <!-- /.Causes-Text -->
								</div> <!-- /.Causes-Item -->
									<?php 
										}
